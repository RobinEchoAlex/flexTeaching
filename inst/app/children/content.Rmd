...
init_list = reactive({
  ...
  #if assignmenet is not released yet, print info and raise error
  validate(
...
output$buttonBox <- renderUI({
  ...
  bl = lapply(names(bs), function(b) {
    ...
    button_reactives[[b]] = reactive({
      ...
      fc = bs[[b]]$f( #call the f, i.e. the handler function defined in the utility.R
...
observeEvent(render_out(), {
  ...
  # parse the js content in 'on-load' field
